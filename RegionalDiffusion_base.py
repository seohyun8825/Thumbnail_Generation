...
# # pipe = RegionalDiffusionPipeline.from_single_file("../models/anything-v3.0/Anything-V3.0-pruned-fp32.safetensors",torch_dtype=torch.float32, use_safetensors=True, variant="fp32")
# pipe = RegionalDiffusionPipeline.from_pretrained("../models/anything-v3.0", use_safetensors=True, torch_dtype=torch.float16)
# pipe.to("cuda")
# pipe.scheduler = DPMSolverMultistepScheduler.from_config(pipe.scheduler.config,use_karras_sigmas=True)
# pipe.enable_xformers_memory_efficient_attention()
# prompt= 'green twintail BREAK red blouse BREAK blue skirt'
# split_ratio= '1;1;1'
# negative_prompt = ""
# images = pipe(
#     prompt=prompt,
...
#     width = 768, 
#     seed = 3208,# random seed
#     guidance_scale = 7.0
# ).images[0]
# print('pipeline.scheduler',pipe.scheduler)
# print('pipeline.scheduler.compatibles',pipe.scheduler.compatibles)
# images.save("anythingv3.png")